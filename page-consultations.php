				...
				<div class="flex flex-col items-center justify-between w-full">
					<div class="flex flex-col items-center justify-center w-full py-5 md:py-6">
						...
						<p class="text-lg text-gray-400 my-7 text-center max-w-lg">
							<?php drras_kses_e( drras_get_post_field( 'page_description', 'Schedule a one-on-one consultation with Dr. Rassouli to discuss your options and make a plan to achieve your goals.' ) ); ?>
						</p>
					</div>
				</div>
			</div>
	...
	<div class="max-w-6xl mx-auto default-px">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:divide-x divide-gray-200">
			...
			<div>
				...
				<div class="flex flex-col space-y-3 text-gray-800 bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-md shadow md:ml-12">
